...
public class MapsFragment extends Fragment implements OnMapReadyCallback, iOnDataFetched {

    private static final String TAG = com.example.jellytrip.MapsFragment.class.getSimpleName();
...
//        thisgetMenuInflater().inflate(R.menu.menu_main, menu);
//        return true;
//    }
...
//        }
    ...
    public void onMapReady(final GoogleMap map) {
        ...
        getDeviceLocation();
        final com.example.jellytrip.MapsFragment normalActivity = this;
    ...
    private void setRoute(LatLng destination){
        ...
        if(currentLocation != null) {
            ...
            Coordinates currentCoor = new CoordinatesImpl(currPoint);
            Coordinates goToCoor = new CoordinatesImpl(goToPoint);
