...
public class CalculatorImpl implements Calculator {
    ...
    private double getDistance(Coordinates from, Coordinates to) throws IOException {
        ...
        String distance  = actualObj.get("rows").get(0).get("elemants").get(0).get("distance").get("value").toString();
    ...
    private String getRequestUrl(Coordinates origin, Coordinates dest){
        ...
        String url = "https://maps.googleapis.com/maps/api/distancematrix/json?units=metric" + str_origin + "&" + str_dest;
